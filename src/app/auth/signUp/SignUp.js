...
const SignUp = ({ classes, handleSubmit, handleCancel, t }) => (
    ...
    <Grid item xs={12}>
      <form onSubmit={handleSubmit}>
        <Grid container className={classes.inputSection} alignItems="center" direction="column" justify="center">
          ...
          <Grid item>
            <Field id="repassword" label={t('retypePassword.label')} name="repassword" component={TextField} type="password" required />
          </Grid>
        </Grid>
...
export default withStyles(Styles)(reduxForm({ form: 'SignUp' })(translate()(SignUp)));
